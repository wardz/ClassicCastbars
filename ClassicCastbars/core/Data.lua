...
namespace.unaffectedCastModsSpells = {
    ...
    [17709] = 1, -- Summon Zergling
    [6619] = 1, -- Cowardly Flight Potion
    [12719] = 1, -- Explosive Arrow
    [10679] = 1, -- Summon White Kitten
    [30021] = 1, -- Crystal Infused Bandage
    [10687] = 1, -- Summon White Plymouth Rock
    [10695] = 1, -- Summon Dark Whelpling
    [10699] = 1, -- Summon Bronze Whelpling
    [13258] = 1, -- Summon Goblin Bomb
    [5106] = 1, -- Crystal Flash
    [10711] = 1, -- Summon Snowshoe Rabbit
    [10715] = 1, -- Summon Blue Racer
    [10719] = 1, -- Summon Ribbon Snake
    [22979] = 1, -- Shadow Flame
    [23530] = 1, -- Summon Tiny Red Dragon
    [24576] = 1, -- Chromatic Mount
    [16967] = 1, -- Inlaid Thorium Hammer
    [16983] = 1, -- Serenity
    [5669] = 1, -- Peon Disguise
    [23650] = 1, -- Ebon Hand
    [24696] = 1, -- Summon Murky
    [3611] = 1, -- Minion of Morganth
    [27794] = 1, -- Cleave
    [25247] = 1, -- Longsight
    [5208] = 1, -- Poisoned Harpoon
    [28505] = 1, -- Summon Poley
    [14532] = 1, -- Creeper Venom
    [3132] = 1, -- Chilling Breath
    [3650] = 1, -- Sling Mud
    [3651] = 1, -- Shield of Reflection
    [3143] = 1, -- Glacial Roar
    [23012] = 1, -- Summon Orphan
    [26086] = 1, -- Felcloth Bag
    [5264] = 1, -- South Seas Pirate Disguise
    [5266] = 1, -- Syndicate Disguise
    [5268] = 1, -- Dark Iron Dwarf Disguise
    [6296] = 1, -- Enchant: Fiery Blaze
    [16984] = 1, -- Volcanic Hammer
    [16992] = 1, -- Frostguard
    [24194] = 1, -- Uther's Tribute
    [17567] = 1, -- Summon Blood Parrot
    [21160] = 1, -- Eye of Sulfuras
    [24266] = 1, -- Gurubashi Mojo Madness
    [7364] = 1, -- Light Torch
    [12684] = 1, -- Kadrak's Flag
    [23811] = 1, -- Summon Jubling
    [22797] = 1, -- Force Reactive Disk
    [12720] = 1, -- Goblin "Boom" Box
    [16729] = 1, -- Lionheart Helm
    [10684] = 1, -- Summon Senegal
    [10688] = 1, -- Summon Cockroach
    [10696] = 1, -- Summon Azure Whelpling
    [10700] = 1, -- Summon Faeling
    [10704] = 1, -- Summon Tree Frog
    [23428] = 1, -- Summon Albino Snapjaw
    [7919] = 1, -- Shoot Crossbow
    [10716] = 1, -- Summon Brown Snake
    [22430] = 1, -- Refined Scale of Onyxia
    [21935] = 1, -- SnowMaster 9000
    ...
    [16450] = 1, -- Summon Smolderweb
    [28738] = 1, -- Summon Speedy
    [16993] = 1, -- Masterwork Stormhammer
    [23652] = 1, -- Blackguard
    [24195] = 1, -- Grom's Tribute
    [16554] = 1, -- Toxic Bolt
    [12900] = 1, -- Mobile Alarm
    [12904] = 1, -- Gnomish Ham Radio
    [6470] = 1, -- Tiny Bronze Key
    [15495] = 1, -- Explosive Shot
    [17169] = 1, -- Summon Carrion Scarab
    [471] = 1, -- Palamino Stallion
    [19772] = 1, -- Summon Lifelike Toad
    [16746] = 1, -- Invulnerable Mail
    [15048] = 1, -- Summon Bomb
    [16082] = 1, -- Palomino Stallion
    [25018] = 1, -- Summon Murki
    [6530] = 1, -- Sling Dirt
    [30152] = 1, -- Summon White Tiger Cub
    [26072] = 1, -- Dust Cloud
    [5514] = 1, -- Darken Vision
    [11016] = 1, -- Soul Bite
    [22567] = 1, -- Summon Ar'lia
    [21050] = 1, -- Melodious Rapture
    [17481] = 1, -- Deathcharger
    [16978] = 1, -- Blazing Rapier
    [25162] = 1, -- Summon Disgusting Oozeling
    [4520] = 1, -- Wide Sweep
    [23653] = 1, -- Nightfall
    [4526] = 1, -- Mass Dispell
    [6576] = 1, -- Intimidating Growl
    [20627] = 1, -- Lightning Breath
    [28324] = 1, -- Forming Frame of Atiesh
    [22719] = 1, -- Black Battlestrider
    [25793] = 1, -- Demon Summoning Torch
    [23254] = 1, -- Redeeming the Soul
    [25849] = 1, -- Summon Baby Shark
    [18711] = 1, -- Forging
    [12198] = 1, -- Marksman Hit
    [8153] = 1, -- Owl Form
    [10673] = 1, -- Summon Bombay
    [10677] = 1, -- Summon Siamese
    [6626] = 1, -- Set NG-5 Charge (Blue)
    [6630] = 1, -- Set NG-5 Charge (Red)
    [10685] = 1, -- Summon Ancona
    [10697] = 1, -- Summon Crimson Whelpling
    [10701] = 1, -- Summon Dart Frog
    [10705] = 1, -- Summon Eagle Owl
    [23430] = 1, -- Summon Olive Snapjaw
    [30081] = 1, -- Retching Plague
    [10717] = 1, -- Summon Crimson Snake
    [10721] = 1, -- Summon Elven Wisp
    [6648] = 1, -- Chestnut Mare
    [22967] = 1, -- Smelt Elementium
    [6656] = 1, -- Remote Detonate
    [23510] = 1, -- Stormpike Battle Charger
    [10254] = 1, -- Stone Dwarf Awaken Visual
    [16987] = 1, -- Darkspear
    [16995] = 1, -- Heartseeker
    [2840] = 1, -- Creeping Anguish
    [2841] = 1, -- Creeping Torment
    [5169] = 1, -- Defias Disguise
    [8286] = 1, -- Summon Boar Spirit
    [3359] = 1, -- Drink Potion
    [22704] = 1, -- Field Repair Bot 74A
    [3363] = 1, -- Summon Riding Gryphon
    [17618] = 1, -- Summon Risen Lackey
    [15999] = 1, -- Summon Worg Pup
    [11923] = 1, -- Repair the Blade of Heroes
    [17235] = 1, -- Raise Undead Scarab
    [16724] = 1, -- Whitesoul Helm
    [8386] = 1, -- Attacking
    [19814] = 1, -- Masterwork Target Dummy
    [15049] = 1, -- Summon Robot
    [23431] = 1, -- Summon Leatherback Snapjaw
    [28311] = 1, -- Slime Bolt
    [26010] = 1, -- Summon Tranquil Mechanical Yeti
    [1698] = 1, -- Shockwave
    [15067] = 1, -- Summon Sprite Darter Hatchling
    [13548] = 1, -- Summon Farm Chicken
    [23008] = 1, -- Powerful Seaforium Charge
    [10703] = 1, -- Summon Wood Frog
    [6951] = 1, -- Decayed Strength
    [5265] = 1, -- Stonesplinter Trogg Disguise
    [5267] = 1, -- Dalaran Wizard Disguise
    [28732] = 1, -- Widow's Embrace
    [15648] = 1, -- Summon Corrupted Kitten
    [16980] = 1, -- Rune Edge
    [16988] = 1, -- Hammer of the Titans
    [23639] = 1, -- Blackfury
    [28487] = 1, -- Summon Terky
    [28995] = 1, -- Stoneskin
    [25146] = 1, -- Transmute: Elemental Fire
    [24706] = 1, -- Toss Stink Bomb
    [6257] = 1, -- Torch Toss
    [27829] = 1, -- Titanic Leggings
    [10682] = 1, -- Summon Hyacinth Macaw
    [7359] = 1, -- Bright Campfire
    [16590] = 1, -- Summon Zombie
    [9612] = 1, -- Ink Spray
    [28740] = 1, -- Summon Whiskers
    [23531] = 1, -- Summon Tiny Green Dragon
    [3436] = 1, -- Wandering Plague
    [9636] = 1, -- Summon Swamp Spirit
    [17707] = 1, -- Summon Panda
    [17204] = 1, -- Summon Skeleton
    [7896] = 1, -- Exploding Shot
    [10712] = 1, -- Summon Spotted Rabbit
    [10674] = 1, -- Summon Cornish Rex
    [12722] = 1, -- Goblin Radio
    [16741] = 1, -- Stronghold Gauntlets
    [23392] = 1, -- Boulder
    [10708] = 1, -- Summon Snowy Owl
    [10698] = 1, -- Summon Emerald Whelpling
    [10702] = 1, -- Summon Island Frog
    [10706] = 1, -- Summon Hawk Owl
    [10710] = 1, -- Summon Cottontail Rabbit
    [7920] = 1, -- Mebok Smart Drink
    [10718] = 1, -- Summon Green Water Snake
    [27830] = 1, -- Persuader
    [8682] = 1, -- Fake Shot
    [10678] = 1, -- Summon Silver Tabby
    [23638] = 1, -- Black Amnesty
    [10720] = 1, -- Summon Scarlet Snake
    [28614] = 1, -- Pointy Spike
    [8016] = 1, -- Spirit Decay
    [10709] = 1, -- Summon Prairie Dog
    [10686] = 1, -- Summon Prairie Chicken
    [2838] = 1, -- Creeping Pain
    [26102] = 1, -- Sand Blast
    [3477] = 1, -- Spirit Steal
    [5395] = 1, -- Death Capsule
    [5668] = 1, -- Peasant Disguise
    [5159] = 1, -- Melt Ore
    [12243] = 1, -- Summon Mechanical Chicken
    [5403] = 1, -- Crash of Waves
    [17460] = 1, -- Frost Ram
    [16965] = 1, -- Bleakwood Hew
    [16973] = 1, -- Enchanted Battlehammer
    [8256] = 1, -- Lethal Toxin
    [23632] = 1, -- Girdle of the Dawn
    [16970] = 1, -- Dawn's Edge
    [28739] = 1, -- Summon Mr. Wiggles
    [6441] = 1, -- Explosive Shells
    [27241] = 1, -- Summon Gurky
    [16986] = 1, -- Blood Talon
    [10675] = 1, -- Summon Maine Coon
    [23429] = 1, -- Summon Loggerhead Snapjaw
    [10850] = 1, -- Powerful Smelling Salts
    [3488] = 1, -- Felstrom Resurrection
    [30047] = 1, -- Crystal Throat Lozenge
    [27832] = 1, -- Sageblade
    [10346] = 1, -- Machine Gun
    [12740] = 1, -- Summon Infernal Servant
    [6469] = 1, -- Skeletal Miner Explode
    [6471] = 1, -- Tiny Iron Key
    [11397] = 1, -- Diseased Shot
    [30156] = 1, -- Summon Hippogryph Hatchling
    [27589] = 1, -- Black Grasp of the Destroyer
    [10683] = 1, -- Summon Green Wing Macaw
    [23432] = 1, -- Summon Hawksbill Snapjaw
    [4950] = 1, -- Summon Helcular's Puppets
    [17708] = 1, -- Summon Diablo
    [8363] = 1, -- Parasite
    [10707] = 1, -- Summon Great Horned Owl
    [16531] = 1, -- Summon Frail Skeleton
    [22027] = 1, -- Remove Insignia
    [10681] = 1, -- Summon Cockatoo
    [26443] = 1, -- Firework Cluster Launcher
    [6510] = 1, -- Blinding Powder
    [16991] = 1, -- Annihilator
    [10713] = 1, -- Summon Albino Snake
    [16072] = 1, -- Purify and Place Food
    [20629] = 1, -- Corrosive Venom Spit
    [10680] = 1, -- Summon Cockatiel
    [10676] = 1, -- Summon Orange Tabby
    [10714] = 1, -- Summon Black Kingsnake
